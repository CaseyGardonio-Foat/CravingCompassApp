...
export class DishService {
  dishes: Dish[] = [
    ...
    new Dish('Poke', 'Traditional salad of fresh, raw fish or seafood--traditionally ahi tuna or octopus--mixed with vegetables, herbs, condiments, and seasoning. Can be served alone as an appetizer or with rice as a full meal.', '../assets/photos/poke_pexels-ania-rude-6169445_masked.png', ['North American', 'USA', 'Hawaiian']),
    new Dish('Kalua Pig', 'Whole, salt-seasoned pig, wrapped with banana or ti leaves, and slow-roasted in an underground pit heated by lava rocks.', '../assets/photos/kaluaPork_KingsHawaiianBakery_masked.png', ['North American', 'USA', 'Hawaiian']),
    new Dish('Laulau', 'Hawaiian dish of pork, butterfish, or other proteins wrapped in luau (taro) leaves and steamed, traditionally in an underground oven heated by lava rocks. Often served with rice and/or poi.', '../assets/photos/lauLau_foodland_masked.png', ['North American', 'USA', 'Hawaiian']),
    new Dish('Shave Ice', 'Popular Hawaiian dessert of shaved (not crushed) ice flavored with fruit syrups and garnished with a variety of toppings.', '../assets/photos/shaveIce_chase-daley-mFfLHPr6ZZs-unsplash_masked.png', ['North American', 'USA', 'Hawaiian', 'dessert']),
