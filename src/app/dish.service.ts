...
export class DishService {
  dishes: Dish[] = [
    ...
    new Dish('Knish', '', '../assets/photos/knish_20150311-knish-max-falkowitz-2_SeriousEats_masked.png', ['knish', 'potato knish', 'americas', 'american', 'us', 'usa', 'united states', 'jewish', 'new york', 'nyc', 'street food', 'potato', 'pastry', 'turnover', 'pasty'], 'warning'),
