...
export class CuisineService {
  cuisines: Cuisine[] = [
    ...
    new Cuisine('Hawaiian', '../assets/foodIcons/USA_Hawaiian_LauLau.svg', 'style', ['United States'], []),
    new Cuisine('Southwestern /TexMex', '../assets/foodIcons/USA_Southwestern-TexMex.svg', 'style', ['United States'], []),
    ...
    new Cuisine('Belgian', '../assets/foodIcons/Belgium_MoulesFrites.svg', 'region', ['Europe'], []),
    ...
    new Cuisine('Pacific Islands', '../assets/foodIcons/USA_Hawaiian_LauLau.svg', 'country', ['Australia-Oceania'], []),
    ...
    new Cuisine('Himalayan', '../assets/foodIcons/Himalayan_Momo.svg', 'region', ['Asia'], []),
